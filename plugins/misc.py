...
async def start(bot, message):
    ...
    await message.reply(text=script.START.format(message.from_user.mention),
                        ...
                        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('➕ Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ Gʀᴏᴜᴘ ➕', url=f'http://t.me/PostSearch_Bot?startgroup=true')
            ],[InlineKeyboardButton("ℹ️ Hᴇʟᴘ", callback_data="misc_help"),
...
async def misc(bot, update):
    ...
    if data=="home":
       await update.message.edit(text=script.START.format(update.from_user.mention),
                                 disable_web_page_preview=True,
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("ℹ️ Hᴇʟᴘ", callback_data="misc_help"),
                                                            InlineKeyboardButton("🧑🏻‍💻 Aʙᴏᴜᴛ", callback_data="misc_about")]])) 
    elif data=="help":
       await update.message.edit(text=script.HELP, 
                                 disable_web_page_preview=True,
                                 reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⬅️ Back", callback_data="misc_start")]])) 
